...
public class BattleRoad3D
{
    ...
    public BattleRoad3D(BattleCanvas canvas, int roadId)
    {
        m_canvas = canvas;
        m_curPosY = 0.0f;
        m_drawPosX = 0.0f;
        ...
        m_roadRectPrefab = UnityEngine.Object.Instantiate(Resources.Load<GameObject>("Road3D/Cube"));
        m_roadCirclePrefab = UnityEngine.Object.Instantiate(Resources.Load<GameObject>("Road3D/Cylinder"));
    ...
    Vector2 GetTouchWorldPos(Vector2 touchPos)
    {
        ...
        //Debug.Log("touchPos " + touchPos + "worldPos " + worldPos);
        //return worldPos;
        ...
        //    Debug.Log("screenPos:" + touchPos);
        //    Debug.Log("spacePos:" + spacePos);
        //    return new Vector2(spacePos.x, spacePos.y);
        //}
        //return new Vector2(0, 0);

        return new Vector2(touchPos.x * 0.01f, touchPos.y * 0.01f);
    }
